 ...
 * @author Melvin
 */
public class BuildingToolboxPanel extends javax.swing.JPanel {
    //TO DO ----------------------------------------------------------------
    int min = 1;
    int max = 3;
    int step = 1;
    ...
    public BuildingToolboxPanel() {
        initComponents();
        //TO DO ------------------------------------------------------------
        wallLvlSpinner.setModel(model);
        gemCount.setValue(1000);
        //TO DO ------------------------------------------------------------
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(readyButton, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
